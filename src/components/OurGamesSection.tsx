  ...
  return (
    <section id="games" className="py-24 bg-[#0a1226] relative overflow-hidden" aria-label="Our Games">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header (referenced directly from Image 2) */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-sky-900/30 pb-6">
          <div>
            ...
            <h2 className="font-display text-3xl sm:text-5xl font-black tracking-wide text-white uppercase">
              OUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-cyan-200">GAMES</span>
            </h2>
            <p className="mt-2 text-sm text-slate-300 max-w-xl">
              Explore our cozy-evil claw machine roguelike debut. Assemble rigged setups, play shady cards, and discover quirky combos!
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            {/* Card Body (referenced from Image 2 layout) */}
